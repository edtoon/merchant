...
export default () => {
  return (
    <div>
      <Head>
        <title>Merchant.GG: YouTube</title>
      ...
      <Columns>
        <aside className='column is-2 aside hero is-fullheight is-hidden-mobile'>
          <div>
            <div className='main'>
              ...
              <a href='/' className='item'><span className='name'>Dashboard</span></a>
              <a href='#' className='item active'><span className='name'>YouTube</span></a>
        ...
        <Column size='is10' className='admin-panel'>
          <nav className='nav has-shadow'>
            <div className='container'>
              ...
              <div className='nav-right nav-menu is-hidden-tablet'>
                ...
                <a href='#' className='nav-item is-active'>YouTube</a>
          ...
          <Hero size='isSmall' style={{paddingLeft: '5px'}}>
            <HeroBody>
              <Container>
                <Title size='is3'><Icon icon='fa fa-credit-card' /> Merchant.GG: YouTube</Title>
                <Subtitle size='is5'>Manage your YouTube credentials.</Subtitle>
                <YouTubeForm />
              </Container>
            </HeroBody>
          </Hero>
