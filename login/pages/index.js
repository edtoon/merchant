      ...
      <div className='container'>
        <div className='columns is-vcentered'>
          <div className='column is-4 is-offset-4'>
            <h1 className='title is-3'><span className='icon'><i className='fa fa-credit-card' /></span> Merchant.GG: Login</h1>
            <LoginForm />
            <div className='has-text-centered'>
              <Link href='/register'><a>Register</a></Link> | <a href='#'>Forgot Password</a>
            </div>
          </div>
        </div>
      </div>
